...
// import {background-img} from '../public/background-img'
  ...
  return (
    <div className='card bg-gray-200  w-[100%]  h-[100vh]  rounded-3xl flex justify-center items-center'>
       ...
       <div className='gap-2 flex '>
        ...
        <img className=' flex justify-center items-center h-[250px] w-[80%] mt-5 rounded-xl shadow-xl' src="public/background-img 1.jpg" alt="image of computer " />
        ...
        <p className='w-[80%] mt-2'>Passionate Frontend Developer that is creating beautiful and responsive Website using React, JavaScript, CSS, tailwind and HTML</p>
        <button className='bg-cyan-600 p-2 rounded-[10px] w-[120px]  mt-5 text-white text-lg'>Hire me</button>
        </div>
